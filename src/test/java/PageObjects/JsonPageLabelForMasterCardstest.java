...
public class JsonPageLabelForMasterCardstest extends ApplicationKeywords {
    ...
    public static Map<String, Object> getJson(String presentValueGroup,String presentValueMap,String expectedKeys){
        ...
        try {
            ...
            JSONArray a3 = i3.getJSONArray("group");


            System.out.println("Main Crds: "+i3);
...
//        getJson("products-for-you","personal-loan","icontitle,iconimage-android,iconlink");
        getJson("apply-for-loans-title","personal","icontitle,iconimage-android,iconlink");
