...
public class JsonPageTitleMasterCardsLablesTesting extends ApplicationKeywords {
    ...
    {
        getJson("emi-network-card","emi-card-icon","icontitle,iconimage-android,iconlink");
