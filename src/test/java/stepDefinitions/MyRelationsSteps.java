...
/////Bills & Recharges
    ...
    public void customer_is_able_to_view_my_relations_section_to_etb_customers() {
        ...
        if (isElementDisplayed(MyRelationsPage.section_MyRelations)) {
            ...
            scrollToWebElement(MyRelationsPage.section_MyRelations);
        } else {
...
//            testStepFailed("failed1");
    ...
    @Then("{string} CTA should be displayed for flexi loan without overdue {string}")
    public void ctaShouldBeDisplayedForFlexiLoanWithoutOverdue(String cta, String tile) {
        MyRelations.withDrawCTAVisibility(cta, tile, "");
    }

    @And("Click on {string} CTA for tile {string}")
    public void clickOnCTAForTile(String cta, String tile) {
        MyRelations.withDrawCTAClick(cta, tile, "");
    }

    @Then("{string} CTA should not be displayed for flexi loan without overdue {string}")
    public void ctaShouldNotBeDisplayedForFlexiLoanWithoutOverdue(String cta, String tile) {
        MyRelations.withDrawCTANonVisibility(cta, tile, "");
    }
    ...
    public void verifyCreditCardIsDisplayedUnderMyRelations(String CCName) {
        ...
        if (Cardname.equalsIgnoreCase(CCName)) {
            ...
            testStepFailed(CCName + " is not Displayed");
    ...
    @Then("Customer should be able to view loan card for on home page for ESOP product {string}")
    public void customerShouldBeAbleToViewLoanCardForOnHomePageForESOPProduct(String lan) {
        MyRelations.esopTileVisibility(lan, "");
    }

    @Then("Active FCP should not be displayed on home page {string}")
    public void activeFCPShouldNotBeDisplayedOnHomePage(String lan) {
        MyRelations.esopTileNonVisibility(lan, "");

    }


    @And("Click on {string} CTA for {string} tile {string}")
    public void clickOnCTAForTile(String cta, String tile, String tiletype) {
        MyRelations.viewDetailsCTAClick(cta, tile, tiletype, "");

    }

    @Then("Below Content should be displayed for LAN {string} with Icon, {string}, {string} and {string} CTA")
    public void belowContentShouldBeDisplayedForLANWithIconAndCTA(String string, String string1, String string2, String string3) {
        MyRelations.esopTileDetails(string, string1, string2, string3, "");
    }

    @Then("Below Content should be displayed for LAN {string} with {string}, {string} and Outstanding loan amount")
    public void belowContentShouldBeDisplayedForLANWithAndOutstandingLoanAmount(String num, String prod, String LAN) {
        MyRelations.esopTileDetailsInMyRelations(num, prod, LAN, "");
    }

    @Then("Customer should be able to view loan card in my relation for closed FCP product {string}")
    public void customerShouldBeAbleToViewLoanCardInMyRelationForClosedFCPProduct(String tile) {
        MyRelations.esopTileVisibilityMR(tile, "");
    }

    @Then("Customer should not be able to view loan card in my relation for active FCP product {string}")
    public void customerShouldNotBeAbleToViewLoanCardInMyRelationForActiveFCPProduct(String tile) {
        MyRelations.esopTileNonVisibilityMR(tile, "");

    }

    @And("Click on ESOP Loan card {string}")
    public void clickOnESOPLoanCard(String tile) {
        MyRelations.esopTileClickMR(tile, "");
    }

    @And("Click on ESOP Loan card with LAN Number {string}")
    public void clickOnESOPLoanCardWithLANNumber(String tile) {
        MyRelations.esopTileClickMRUsingLAN(tile, "");
    }

    @Then("Below Options {string} should be displayed in Filter for Cards")
    public void belowOptionsShouldBeDisplayedInFilterForCards(String opt) {
        verifyFieldsUsingCommonXpathAndMultipleTextWithHash("//div[@class='Relation_Status_title']/following-sibling::ul//li//label", opt, "");
    }

    @And("Below text {string} should be displayed")
    public void belowTextShouldBeDisplayed(String field) {
        verifyFieldsDisplayedUsingText(field);
    }
}