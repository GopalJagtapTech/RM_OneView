...
##########Services
  Scenario Outline: To verify Insurance Page Sections - Cancelled Non Funded
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212       | Policy , Relationship Details, Quick Actions, Frequently asked questions, Check your CIBIL Score |

  @Serv
  Scenario Outline: To verify Top section in Insurance Page - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Then verify "PREMIUM AMOUNT" format as <Rs. Digits>
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 | Policy No : | PREMIUM AMOUNT | Policy Start Date |

  @Serv
  Scenario Outline: To verify Relationship Details Section - Nominee Details - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 | Nominee Name, Nominee Relation |

  @Serv
  Scenario Outline: verify Customer is redirected to FAQ Page when click on FAQ - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 |

  @Serv
  Scenario Outline: verify Customer is redirected to CIBIL Page when Customer click on know your Cibil - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 |
  @Serv
  Scenario Outline: verify Given buttons are displayed under 'Quick Actions' at RHS Section - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 | View Documents |

  @Serv1
  Scenario Outline: verify Cancelled nudge in Cancelled Insurance - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Insurance Services- View Documents - Cancelled Non Funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9847116906    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0339522212 | For your policy documents, please connect with Insurance Partner. |
