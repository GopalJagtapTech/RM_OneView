@Regression @mult
Feature: Insurance Services- Active Funded(VAS)

  @Serv
  Scenario Outline: To verify Insurance tile in My Relation page redirected to Insurance page - VAS
  ...
  @Serv
  Scenario Outline: To verify Insurance Page Sections - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Policy , Relationship Details, Quick Actions, Frequently asked questions, Check your CIBIL Score |

  @Serv
  Scenario Outline: To verify Top section in Insurance Page - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Then verify "PREMIUM AMOUNT" format as <Rs. Digits>
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Policy No : | PREMIUM AMOUNT | Policy Start Date, Policy End Date |

  @Serv
  Scenario Outline: To verify Relationship Details Section - Linked Loan Details - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Loan Account Number, EMI Amount, Next EMI Due Date, Loan Tenor |

  @Serv
  Scenario Outline: To verify Relationship Details Section - Nominee Details - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle                 | Account No               | Label Names                    |
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Nominee Name, Nominee Relation |

  @Serv
  Scenario Outline: verify Customer is redirected to FAQ Page when click on FAQ - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Serv
  Scenario Outline: verify Customer is redirected to CIBIL Page when Customer click on know your Cibil - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | https://www.bajajfinserv.in/check-free-cibil-score |

  @Serv
  Scenario Outline: verify Given buttons are displayed under 'Quick Actions' at RHS Section - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Claim Request#View Documents#Update Policy Details#Surrender Policy#Cancel Policy |
...
#    Claim Request
  @ClaimReq
  Scenario Outline:  verify Customer is redirected to "Claim Request Page" when Customer Click on "Claim Request" CTA - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify the header text displayed when customer is on "Claim Request" Page - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify Customer is able to view the list of Document that need to upload for Claim Request - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify Customer is redirected to to RAR page when Customer click on Raise a Request CTA - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Claim Request VAS
  @ClaimReq
  Scenario Outline: verify customer is able to redirect to the document upload screen when clicks on Claim Request - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @ClaimReq @rerun2
  Scenario Outline: verify the message diplayed when customer clicks on (i) tolltip of Claim Invoice Asset Invoice Copy - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Cancel Policy
  @Cancel
  Scenario Outline:  verify Customer is redirected to Cancellation Policy Page when Customer click on Cancel Policy CTA from RHS - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline:  verify Customer is able to view following Details on Cancellation Policy Page - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify customer is abe to view Details under Policy Details Section - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
#    Check the Dropdown
  Scenario Outline: verify Customer is able to view the list of Reason to Cancel the Policy - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify Customer is able to view selected Reason & Change the Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Financial Problem | Change of Mind |


  @Cancel
  Scenario Outline: verify Customer is redirected to Insurance page when customer click on Keep the Policy CTA - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify Customer is redirected to RAR page when click on Cancel Policy after selecting a Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Financial Problem | Select the product for which you wish to raise a request |

  @Cancel
  Scenario Outline: verify Customer gets a validation when click on Cancel Policy Button without selecting Cancel Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Updatepolicy
  Scenario Outline: verify Customer is redirected to RAR page after Clicking on Update Policy Details - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Then verify customer is redirected to RAR page for "<Account No>"
    ...
    Examples:
      ...
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | Select the product for which you wish to raise a request |
...
#Surrender Policy
  @Surr
  Scenario Outline: verify Customer is able to view the Details when Customer click on Surrender Policy CTA from Thing you can do RHS - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view Details under Policy Details Section - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view the list of Surrender Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view selected Surrender Reason and Change the Surrender Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer gets a validation when click on Surrender Policy Button without selecting Surrendering Reason - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer redirected to Service Page when click on Keep the Policy Button - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify customer successfully completes Surrender Policy Journey - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Surrender Policy - 25112022
  ...
  @Docs
  Scenario Outline: Insurance Services- View Documents - VAS
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And Verify Customer Redirected to "MyAccountDocumentCenter/DocumentCenter/docCenter_Insurance" Url

    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle                 | Account No               | Msg                                                               |
      | 9443255624    | 27111995 | Individual    | BAGIC- GENERAL INSURANCE | OG-20-1000-6609-00134221 | For your policy documents, please connect with Insurance Partner. |
