#@Regression
Feature: Insurance Services- Active Non Funded(Health)

##########Services
  Scenario Outline: To verify Insurance Page Sections - Non funded
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Policy , Relationship Details, Quick Actions, Frequently asked questions, Check your CIBIL Score |

  @Serv
  Scenario Outline: To verify Top section in Insurance Page - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Then verify "PREMIUM AMOUNT" format as <Rs. Digits>
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Policy No : | PREMIUM AMOUNT | Policy Start Date, Policy End Date |

  @Serv
  Scenario Outline: To verify Relationship Details Section - Nominee Details - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Nominee Name, Nominee Relation |

  @Serv
  Scenario Outline: verify Customer is redirected to FAQ Page when click on FAQ - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 |

  @Serv
  Scenario Outline: verify Customer is redirected to CIBIL Page when Customer click on know your Cibil - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 |https://www.bajajfinserv.in/check-free-cibil-score |

  @Serv @rrr
  Scenario Outline: verify Given buttons are displayed under 'Quick Actions' at RHS Section - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Claim Request#View Documents#Update Policy Details#Surrender Policy#Cancel Policy |
...
#####RHS
  #    Claim Request
  @ClaimReq
  Scenario Outline:  verify Customer is redirected to "Claim Request Page" when Customer Click on "Claim Request" CTA - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify the header text displayed when customer is on "Claim Request" Page - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify Customer is able to view the list of Document that need to upload for Claim Request - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9545458457    | 16061982 | Individual    | BALIC- LIFE INSURANCE | GTLN_283037478 |
  ...
  @ClaimReq
  Scenario Outline:  verify Customer is redirected to to RAR page when Customer click on Raise a Request CTA - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Claim Request VAS
  @ClaimReq @rerun
  Scenario Outline: verify customer is able to redirect to the document upload screen when clicks on Claim Request - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Photo ID#Policy copy#Discharge summary / OPD-IPD Papers / Medical reports#Cancelled Cheque Leaf / Passbook page with account details |


################
  @Cancel
  Scenario Outline:  verify Customer is redirected to Cancellation Policy Page when Customer click on Cancel Policy CTA from RHS - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline:  verify Customer is able to view following Details on Cancellation Policy Page - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify customer is abe to view Details under Policy Details Section - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
#    Check the Dropdown
  Scenario Outline: verify Customer is able to view the list of Reason to Cancel the Policy - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify Customer is able to view selected Reason & Change the Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Financial Problem | Change of Mind |

  @Cancel
  Scenario Outline: verify Customer is redirected to Insurance page when customer click on Keep the Policy CTA - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Cancel
  Scenario Outline: verify Customer is redirected to RAR page when click on Cancel Policy after selecting a Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 | Financial Problem | Select the product for which you wish to raise a request |

  @Cancel
  Scenario Outline: verify Customer gets a validation when click on Cancel Policy Button without selecting Cancel Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    #########
  @Updatepolicy
  Scenario Outline: verify Customer is redirected to RAR page after Clicking on Update Policy Details - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    Then verify customer is redirected to RAR page for "<Account No>"
    ...
    Examples:
      ...
      | 9220049574    | 27111995 | Individual    | BALIC- LIFE INSURANCE | 0336769237 |Select the product for which you wish to raise a request      |

##########
  @Surr
  Scenario Outline: verify Customer is able to view the Details when Customer click on Surrender Policy CTA from Thing you can do RHS - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view Details under Policy Details Section - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view the list of Surrender Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer is able to view selected Surrender Reason and Change the Surrender Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer gets a validation when click on Surrender Policy Button without selecting Surrendering Reason - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Surr
  Scenario Outline: verify Customer redirected to Service Page when click on Keep the Policy Button - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @rerun
  Scenario Outline: verify customer successfully completes Surrender Policy Journey - Non funded
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
