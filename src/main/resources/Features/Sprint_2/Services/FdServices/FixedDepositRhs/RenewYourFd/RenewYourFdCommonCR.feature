...
Feature: FD Services RHS - Renew your FD - CR - Individual/HUF/NRI

@Pass
  Scenario Outline: Active FD - Renew Your FD is Showing in RHS for <Customer Type>
    ...
    Then verify RHS "Quick Actions" following Options: "Renew your FD" are Displayed
    ...
    Examples:
      ...
      | 9821127115    | 19091970 | Individual    | 229405     |
#      |     | 19091970 | HUF    | 229405     |
      | 9152730508    | 19091970 | NRI    | 910242     |
