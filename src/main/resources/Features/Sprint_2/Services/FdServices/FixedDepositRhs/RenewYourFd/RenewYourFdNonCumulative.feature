@notrenew@Run03022023@FD2
Feature: FD Services RHS - Renew your FD - Non Cumulative

  @Pass
  Scenario Outline: To verify Renew your FD redirected to Renewal Detail Page - Non Cumulative
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |

  @Pass
  Scenario Outline: To verify Components of Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify Cancel button in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify Top Section in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify Deposit Summary Section in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify Bank Details Section in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify Broker Details Section in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify New Broker Code Text Box in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify New Broker Name Text Box in Renew Details Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails |
  @Pass
  Scenario Outline: To verify User Redirected to Renewal Details page with Existing Broker Details - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
  @Pass
  Scenario Outline: To verify User Redirected to Renewal Details page with New Broker Details - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
############################################# Renew Plan Page ##################################################
  ...
  @Pass
  Scenario Outline: To verify Top Section in Renew Plan Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
@Pass
  Scenario Outline: To verify Components of Renewal Plan page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And verify "Choose from our two options" "Label" is Displayed
...
#Interest values not yet Updated due to Bugs
  @Bug@Ignore
  Scenario Outline: To verify Renewal Plan Maturity Amount Calculator for Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: To verify Default Options in Renew Plan Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
  @Pass
  Scenario Outline: To verify Choose Plan from two Options in Renew Plan Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And verify "Principal + Interest Option in Renew Plan" is Not Displayed
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
  @Pass
  Scenario Outline: To Validate Renewal Amount Text box in Renew Plan Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And Verify "Renew Amount Text Box Error Message" for following values: "Greater Than Maturity Amount and Less Than 15 K" in Renew Amount Edit Box for Non Cumulative
    And Verify Not Showing "Renew Amount Text Box Error Message" for following values: "Less Than Maturity Amount and Greater Than 15 K" in Renew Amount Edit Box for Non Cumulative
    Examples:
      | Mobile Number | Date     | Customer Type | Acc Number | url                                                 | urlRenewPlan                                     |
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
  @Pass
  Scenario Outline: To Verify Custom Option Textbox in Select Tenure - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan |
  @Pass
  Scenario Outline: To Verify Interest rates Link Text - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: To Verify redirected to FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan | MyAccountFixedDeposit/FixedDeposit/FDRenewalSummary |

  @Pass
  Scenario Outline: To Verify Components of FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan | MyAccountFixedDeposit/FixedDeposit/FDRenewalSummary |
  @Pass
  Scenario Outline: To Verify Cancel Button in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan | MyAccountFixedDeposit/FixedDeposit/FDRenewalSummary |
  @Pass
  Scenario Outline: To Verify Edit Investment Details Button in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan | MyAccountFixedDeposit/FixedDeposit/FDRenewalSummary |
  @Pass
  Scenario Outline: To Verify Deposit Summary Section in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9820041515    | 19051999 | Individual    | 43709     | MyAccountFixedDeposit/FixedDeposit/FDRenewalDetails | MyAccountFixedDeposit/FixedDeposit/FDRenewalPlan | MyAccountFixedDeposit/FixedDeposit/FDRenewalSummary |
  @Pass
  Scenario Outline: To Verify Terms and Conditions Checkbox in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    And Verify Customer Redirected to "<urlRenewSummary>" Url
  ...
  @Pass
  Scenario Outline: To Verify Components of OTP and Close Button in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: To Verify OTP Timing & Resend Button in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
@Pass
  Scenario Outline: To Verify OTP Validations in FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    And "Submit Button in Renew FD OTP Screen" is Disabled
  ...
  @DataIssue
  Scenario Outline: To Verify Success Screen in FD Renew Process - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @DataIssue
  Scenario Outline: To Verify Already Renewal Proceess Done message in FD Renew Process - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    ##########################################################################################################################################################
  @Pass1
  Scenario Outline: To Verify All Combinations of Plans redirected to FD Renew Summary Page - Non Cumulative
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
