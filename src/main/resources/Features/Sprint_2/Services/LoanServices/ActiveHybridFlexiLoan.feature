@AHFLS@Run02022023@Run02022023_3
Feature: Active Hybrid Flexi Loan Services
@Pass
  Scenario Outline: Active Hybrid Flexi Loan - Redirection to Loan services Page
...
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
#      #      | 9642078253    | 27121985 | Individual    | FLEXI HYBRID LOAN | P400DPL1667428 |
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Section in Loan Service Page
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Top Section in Loan services Page Without EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify Top Section Details for "Active Hybrid Flexi Loan without EMI Overdue"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Top Section in Loan services Page With EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify Top Section Details for "Active Hybrid Flexi Loan with EMI Overdue"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
      #      | 9642078253    | 27121985 | Individual    | FLEXI HYBRID LOAN | P400DPL1667428 |
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |

  Scenario Outline: Active Hybrid Flexi Loan - Top Section in Loan services Page With Last EMI Only
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify Top Section Details for "Active Hybrid Flexi Loan with Last EMI"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |

  Scenario Outline: Active Hybrid Flexi Loan - Top Section in Loan services Page With Last EMI and EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify Top Section Details for "Active Hybrid Flexi Loan with Last EMI and Overdue"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |

  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section without Fees & Charges
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | TERM LOAN | 402TPLGN546122 |
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section without Insurance Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | TERM LOAN | 402TPLGN546122 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section without Insurance Details, Fees& Charges
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section All 4 Fields
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | TERM LOAN | 402TPLGN546122 |
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Loan Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify following "Loan Details" in Relationship Section: "Number of EMIs Paid, EMI Start Date, EMI End Date, Initial Loan Tenure, Subsequent Loan Tenure, Loan Amount Paid Till Date, Disbursement Date"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
      #      | 9642078253    | 27121985 | Individual    | FLEXI HYBRID LOAN | P400DPL1667428 |
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Bank Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass@New
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Bank Details - Verify Change Bank Account Button
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Bank Details - Bank Account Number - Masked format
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Insurance Details - Single
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Insurance Details - Multiple
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Multiple Insurance Policy Accordian Icon
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Relationship Section - Fees & Charges Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  ...
  @Pass
Scenario Outline: Active Hybrid Flexi Loan - RHS Sections
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Hybrid Flexi Loan - RHS Sections - Withdraw
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      #      | 9642078253    | 27121985 | Individual    | FLEXI HYBRID LOAN | P400DPL1667428 |
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - RHS Sections - Withdraw with EMI overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - RHS Sections - Make Payments
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - RHS Sections - View Statements
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Hybrid Flexi Loan - Has Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then Pre-Approved Offers Section is "Visible" to "Active Hybrid FLEXI HYBRID LOAN" Service Page
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 8796738158    | 13011992 | Individual    | FLEXI HYBRID LOAN | 402TPLGN546122 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Has NO Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then Pre-Approved Offers Section is "Not Visible" to "Active Hybrid FLEXI HYBRID LOAN" Service Page
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
      #      | 9642078253    | 27121985 | Individual    | FLEXI HYBRID LOAN | P400DPL1667428 |
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Verification & Redirection(FAQ)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Verification & Redirection(Cibil)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      ...
      | 9113074693    | 27121985 | Individual    | FLEXI TERM LOAN | P401PSP2909397 |
  @Pass
  Scenario Outline: Active Hybrid Flexi Loan - Verify Tool Tip Icon
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
