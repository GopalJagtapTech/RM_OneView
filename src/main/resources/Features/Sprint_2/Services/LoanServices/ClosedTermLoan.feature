@CTLS@Run02022023@Run02022023_3
Feature: Closed Term Loan Services
  @Pass
  Scenario Outline: Closed Term Loan - Redirection to Loan services Page
  ...
  @Pass
  Scenario Outline: Closed Term Loan - Section in Loan Service Page
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
      | 9443703371    | 19051999 | Corporate    | TERM LOAN | 5550PL15072698 |
  @Pass
  Scenario Outline: Closed Term Loan - Top Section in Loan services Page
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then verify Top Section Details for "Closed Term Loan"
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
      | 9443703371    | 19051999 | Corporate    | TERM LOAN | 5550PL15072698 |
  @Pass
  Scenario Outline: Closed Term Loan - Relationship Section - Loan Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
      | 9443703371    | 19051999 | Corporate    | TERM LOAN | 5550PL15072698 |
  @Pass
  Scenario Outline: Closed Term Loan - Relationship Section - Bank Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
      | 9443703371    | 19051999 | Corporate    | TERM LOAN | 5550PL15072698 |
  @Pass
  Scenario Outline: Closed Term Loan - Relationship Section - Bank Details - Bank Account Number - Masked format
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
  ...
  @Pass
Scenario Outline: Closed Term Loan - RHS Sections
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
  ...
  @Pass
  Scenario Outline: Closed Term Loan - RHS Sections - View Statements
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
  ...
  Scenario Outline: Closed Term Loan - Has Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then Pre-Approved Offers Section is "Visible" to "Closed Term Loan" Service Page
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
#      | 8796738158    | 13011992 | Individual    | TERM LOAN | 402TPLGN546122 |
  @Pass
  Scenario Outline: Closed Term Loan - Has NO Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
    ...
    And click on "Loans" tab
    And verify Customer is able to go to Service screen from My Relations using subtitle"<Subtitle>" Account No"<Account No>"
    Then Pre-Approved Offers Section is "Not Visible" to "Closed Term Loan" Service Page
    Examples:
      | Mobile Number | Date     | Customer Type | Subtitle  | Account No     |
      | 9443703371    | 19051999 | Corporate    | TERM LOAN | 5550PL15072698 |
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
  @Pass
  Scenario Outline: Closed Term Loan - Verification & Redirection(FAQ)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 9403699977    | 19051999 | Individual    | TERM LOAN | 414PHT25533409 |
  ...
  @Pass
  Scenario Outline: Closed Term Loan - Verification & Redirection(Cibil)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
