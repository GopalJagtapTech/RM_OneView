Feature: Active Flexi Loan Services
  ...
  Scenario Outline: Active Flexi Loan - Draw Down - Redirection to Loan services Page
    ...
    Examples:
      ...
      | 9269942547    | 15071992 | Individual    | FLEXI TERM LOAN | P419PGD2639440 |

  Scenario Outline: Active Flexi Loan - Draw Down - Home My Relations - Flexi Loan Tile  - View Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Section in Loan Service Page
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Top Section in Loan services Page Without EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Top Section in Loan services Page With EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
@Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Top Section in Loan services Page With Last EMI Only
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  Scenario Outline: Active Flexi Loan - Draw Down - Top Section in Loan services Page With Last EMI and EMI Overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section without Fees & Charges
#    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
#    When User is on Home Page
#    And Customer is able to view My Relations Section to ETB Customers
#    And Customer clicks on view all option
...
##      | 8796738158    | 13011992 | Individual    | FLEXI TERM LOAN | 402TPLGN546122 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section without Insurance Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section without Insurance Details, Fees& Charges
#    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
#    When User is on Home Page
#    And Customer is able to view My Relations Section to ETB Customers
#    And Customer clicks on view all option
...
##      | 8796738158    | 13011992 | Individual    | TERM LOAN | 402TPLGN546122 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section All 4 Fields
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Loan Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Bank Details
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Bank Details - Verify Change Bank Account Button
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Bank Details - Bank Account Number - Masked format
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Insurance Details - Single
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8796738158    | 13011992 | Individual    | FLEXI TERM LOAN | 402TPLGN546122 |
  ...
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Insurance Details - Multiple
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Multiple Insurance Policy Accordian Icon
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#  @Pass
#  Scenario Outline: Active Flexi Loan - Draw Down - Relationship Section - Fees & Charges Details
#    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
#    When User is on Home Page
#    And Customer is able to view My Relations Section to ETB Customers
#    And Customer clicks on view all option
...
#      | 7416257695    | 01011990 | Individual    | FLEXI LOAN | P400SOF0124200 |
  ...
  @Pass
Scenario Outline: Active Flexi Loan - Draw Down - RHS Sections
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  @Bug
  Scenario Outline: Active Flexi Loan - Draw Down - RHS Sections - Withdraw without EMI overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - RHS Sections - Withdraw with EMI overdue
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#    And verify Withdraw with EMI Overdue option in RHS Section
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - RHS Sections - Make Payments
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
      | 8888890933    | 15071992 | Individual    | FLEXI TERM LOAN | 400FLFHE869061 |
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - RHS Sections - View Statements
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
      | 8888890933    | 15071992 | Individual    | FLEXI TERM LOAN | 400FLFHE869061 |
@Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Has Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Has NO Pre-Approved Offers
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Verification & Redirection(FAQ)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
#      | 8446409507    | 15071992 | Individual    | FLEXI TERM LOAN | 405SPF87590531 |
  ...
  @Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Verification & Redirection(Cibil)
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
...
@Pass
  Scenario Outline: Active Flexi Loan - Draw Down - Verify Tool Tip Icon
    Given User is logged in "<Mobile Number>" "<Date>" for "<Customer Type>"
    When User is on Home Page
    And Customer is able to view My Relations Section to ETB Customers
    And Customer clicks on view all option
